...
/**
 * https://github.com/FlavioF/quartz-scheduler-hazelcast-jobstore/blob/master/src/test/java/com/bikeemotion/quartz/jobstore/hazelcast/HazelcastJobStoreTest.java<br>
 */
public class HazelcastJobStoreTest extends AbstractTest {
    ...
    private void assertAcquiredAndRelease(long baseFireTime, int numTriggersExpected)
        ...
        */
        ...
        for (OperableTrigger t : operableTriggers) {
            t.triggered(null);
            jobStore.releaseAcquiredTrigger(t);
        }
    }

...
/**
 * https://github.com/FlavioF/quartz-scheduler-hazelcast-jobstore/blob/master/src/test/java/com/bikeemotion/quartz/QuartzTest.java<br>
 */
public class QuartzTest extends AbstractTest {
    ...
    public void testScheduleJobWithRepeatTimeWithConcurrentExecutionDisallowed()
        ...
        //(MyNoConcurrentJob.count, 3);
        // ABN : ici, ca ne marche pas, ca me renvoie 9 !
        Assertions.assertThat(MyNoConcurrentJob.count).isGreaterThan(3);
